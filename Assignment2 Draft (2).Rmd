...
Intro: Bélanger, Éric, and Jean-François Godbout. "Forecasting Canadian
Federal Elections." PS: Political Science and Politics 43, no. 4 (2010):
691--99. <http://www.jstor.org/stable/40927037>.

Cohn, Nate. "Why the Surprise over 'Brexit'? Don't Blame the Polls." The
...
"Why Older Citizens Are More Likely to Vote - US News & World Report."
...
Akee, Randall, Randall Akee, Lynne Pepall and Dan Richards, Lynne
Pepall, and Dan Richards. "Voting and Income." Econofact, February 7,
2019. <https://econofact.org/voting-and-income>.

Ahearn, C.E., Brand, J.E. & Zhou, X. How, and For Whom, Does Higher
...
plot9 <- ggplot(data = survey_new, aes(x = factor(income_family, level = c('Less than $25,000', '$25,000 to $49,999', '$50,000 to $74,999', '$75,000 to $99,999', '$100,000 to $ 124,999', '$125,000 and more')))) +
         geom_bar(color = "black",
                        fill = "light blue") +
  labs(x = "Family Income", y = "Number of Respondents", caption = "Figure 5: Survey Respondent Family Income Barplot") + 
  coord_flip()
...
plot10 <- ggplot(data = census_data, aes(x = factor(income_family, level = c('Less than $25,000', '$25,000 to $49,999', '$50,000 to $74,999', '$75,000 to $99,999', '$100,000 to $ 124,999', '$125,000 and more')))) +
         geom_bar(color = "black",
                        fill = "light blue") +
  labs(x = "Family Income", y = "Number of Respondents", caption = "Figure 6: Census Respondent Family Income Barplot") + 
  coord_flip()

plot11 <- ggplot(data = survey_new, aes(x = sex)) +
         geom_bar(color = "black",
                        fill = "light blue") +
  labs(x = "Sex", y = "Number of Respondents", caption = "Figure 7: Survey Respondent Sex Barplot")

plot12 <- ggplot(data = census_data, aes(x = sex)) +
         geom_bar(color = "black",
                        fill = "light blue") +
  labs(x = "Sex", y = "Number of Respondents", caption = "Figure 8: Census Respondent Sex Barplot")
